...
export default function AdminAdsClient({ initialAds }: Props) {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight flex items-center gap-2">
            <Megaphone className="h-6 w-6 text-(--color-yru-pink)" />
            ระบบจัดการโฆษณา
          </h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <Dialog open={isDialogOpen} onOpenChange={(open) => {
            ...
            <DialogTrigger asChild>
              <Button className="rounded-xl whitespace-nowrap gap-2 bg-(--color-yru-pink) hover:bg-(--color-yru-pink-dark) text-white">
            ...
            <DialogContent className="sm:max-w-[750px]">
              ...
              <div className="grid md:grid-cols-2 gap-6 py-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid gap-2">
                    ...
                    <label className={`relative w-full h-40 rounded-xl border-2 border-dashed flex flex-col items-center justify-center text-muted-foreground bg-muted/20 transition-all ${!uploading ? 'cursor-pointer hover:bg-muted/40' : 'cursor-wait opacity-80'} overflow-hidden group`}>
                      {uploading ? (
                        ...
                        <>
                          ...
                          <span className="text-xs text-muted-foreground mt-1 text-center px-4">ไฟล์ JPG, PNG, WEBP (ไม่เกิน 5MB)</span>
                        </>
                      )}
                      <input
                        type="file"
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid gap-2">
                    <label className="text-sm font-medium">แท็กเป้าหมาย (คั่นด้วยลูกน้ำ ",")</label>
                    <Input
                  ...
                  <div className="flex items-center gap-2 mt-4 p-3 border rounded-xl bg-green-500/5 border-green-500/20">
                    <input
                      type="checkbox"
                      id="is_active"
              ...
              <div className="flex justify-end gap-3 mt-4 pt-4 border-t border-border/40">
                ...
                <Button onClick={saveAd} disabled={uploading} className="rounded-xl px-6 bg-(--color-yru-pink) hover:bg-(--color-yru-pink-dark) text-white">
                  {uploading ? (
